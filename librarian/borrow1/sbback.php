<?php
	...
	$num1=$num1+1;
		...
		$reg = "UPDATE books SET BStatus='Not available' WHERE ISBN='$isbn'";
		...
		$tid = $num1;
		$reg3 = " insert into transac(TID, start_date,end_date,T_JNO,T_PNO,T_ISBN) values ('$tid', '$start', '$end3', ' ', ' ', '$isbn')";
		$res = mysqli_query($con, $reg3);
		
		$reg4 = "insert into student_does(TIDD, DSUSN) values ('$tilod','$lsusn')";
