...
$sq2="SELECT USN, Sname, Semester, Res_Name, Res_Edition, Res_Publisher, Res_Author 

FROM `student`JOIN `reservation`  ON  USN=Res_SUSN
...
while($row= mysqli_fetch_assoc($result1))
	{
		echo "<tr>
			...
			<td>".$row["Res_Name"]."</td>
			<td><br/>".$row["Res_Edition"]."</td>
			<td>".$row["Res_Publisher"]."</td>
			<td><br/>".$row["Res_Author"]."</td>
